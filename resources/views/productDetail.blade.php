                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-pic-zoom">
                            <img class="product-big-img" src="{{$product->img}}"
                                 alt="">
                            <div class="zoom-icon">
                        ...
                        <div class="product-thumbs">
                            <div class="product-thumbs-track ps-slider owl-carousel">
                                @foreach($product->otherImg as $value)
                                    <div class="pt active" data-imgbigurl="{{$value}}"><img
                                                src="{{$value}}" alt=""></div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="product-details">
                           ...
                           <!--
                                        ...
                                        @foreach($features as $value)
                                            @if($value->type == 'selectBox')
                                                <div class="sc-item">
                                                    ...
                                                    <label for="md-size" class="labelSelectBox" data-type='selectBox' data-value="{{$value->id}}">{{$value->name}}</label>
                                                </div>
                                            @endif
                                        @endforeach
                                    </label>
                                        ...
                                        @foreach($features as $value)
                                            @if($value->type == 'checkBox')
                                                <div class="sc-item">
                                                    ...
                                                    <label for="sm-size" class="labelCheckBox" data-type='checkBox' data-value="{{$value->id}}">{{$value->name}}</label>
                                                </div>
                                            @endif
                                        @endforeach
                                    </label>
                            ...
                            <div class="quantity">
                                ...
                                <span style="cursor: pointer" class="primary-btn pd-cart" onclick="addItem()">Sepete Ekle</span>
                            </div>
                            <ul class="pd-tags">
    ...
    $(window).on('load', function () {
      ...
      $(".fw-size-choose .sc-item label, .pd-size-choose .sc-item label").on('click', function () {
        if(this.dataset.type === 'selectBox'){
          $(".fw-size-choose .sc-item .labelSelectBox, .pd-size-choose .sc-item .labelSelectBox").removeClass('active');
          selectBoxData = this.dataset.value ;
        }else if(this.dataset.type === 'checkBox'){
          $(".fw-size-choose .sc-item .labelCheckBox, .pd-size-choose .sc-item .labelCheckBox").removeClass('active');
